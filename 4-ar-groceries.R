...
#Find Frequent Itemset- eclat
frequentItems = eclat (Groceries, parameter = list(supp = 0.01, minlen= 1, maxlen = 5)) 
...
inspect(sort (frequentItems, by="count", decreasing=F)[1:10])
...
# Create rules and the relationship between items=apriori
